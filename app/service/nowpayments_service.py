...
class NOWPaymentsService:
    ...
    async def create_invoice(self, invoice_data: NOWPaymentsInvoiceRequest, user_id: UUID) -> Any:
    ...
    async def create_payment(self, payment_data: NOWPaymentsPaymentRequest, user_id: UUID) -> Any:
